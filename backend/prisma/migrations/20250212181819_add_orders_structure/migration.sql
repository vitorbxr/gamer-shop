/*
  ...
  - You are about to drop the column `largeImageUrl` on the `product` table. All the data in the column will be lost.
  - You are about to drop the column `mediumImageUrl` on the `product` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `product` DROP COLUMN `largeImageUrl`,
